...
public class SolarGrinderBlock extends SimplelifeModElements.ModElement {
	@ObjectHolder("simplelife:solar_grinder")
	public static final Block block = null;
	public SolarGrinderBlock(SimplelifeModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(3.5f, 10f).setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("solar_grinder");
		}
