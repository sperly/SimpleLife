...
public class SolarHarvesterGUIGui extends SimplelifeModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public SolarHarvesterGUIGui(SimplelifeModElements instance) {
		super(instance, 25);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("solar_harvester_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, SolarHarvesterGUIGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 115, 26) {
				@Override
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 151, 26) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 115, 44) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			...
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 151, 44) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
